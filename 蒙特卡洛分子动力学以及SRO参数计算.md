...
```
分别定义MC间隔、单次交换原子对的数量、随机种子、模拟温度。~~对于高熵合金这种2种以上元素参与交换的情况，需要设置semi-grand yes使用半巨正则系综，通过types设置参与交换原子的种类，当使用semi-grand yes时需要设置各个元素的化学势，使用mu将各元素相对化学势设置为0，保证原子交换没有偏好性。~~（**semi grand半正则系综实际上是选定原子并对其进行替换，会在不改变原子总数的前提下改变原子种类的比例，g**）



<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc5NzI5NTQzLDE2MzY5NDcwMTYsLTEzMT
Q1MDA5NDksMTAwNjY1NTU2NywtMjA3MjEzMjcyNiwxODgyMzQ2
NzI0LDE5MzA4Mzk2NzksMTA3NjMxNzE1NCwtOTY4MTYwNzk2LD
g1NTg4OTY4NywtNDQ1NTIzMTI1LC0yMDA0MTY5NDM0LC0xNzc4
NjgwNzAzLDIzNDgxNjIzNCwxMTg2Mzk2Mjk0LDE3NjAwMTAzMj
gsMjEzOTgwMzAyMywtNTI2NDI2MzMxLDE5Nzc1ODQwOCw0NjUw
MTk5ODRdfQ==
-->