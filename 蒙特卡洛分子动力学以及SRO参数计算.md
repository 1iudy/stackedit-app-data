...
文献中单晶超胞约有14000个原子，因此对于单晶结构使用元胞**各方向扩胞19**；纳米多晶结构包含102000个原子，使用元胞**各方向扩胞47**。查询文献和数据库，TaNbHf高熵合金晶格常数约为3.36Å，以Nb25Ta25Hf5Zr45为li代码
```
atomsk --create bcc 3.36 Nb -duplicate 19 19 19 Nb_supercell.xsf
```
超胞结构共13718个原子，
<!--stackedit_data:
eyJoaXN0b3J5IjpbODk3MjM4MDgzLDE5Nzc1ODQwOCw0NjUwMT
