...
其中，$f_{\text{cut}}(r_{ij})$ 是截断函数，$r_{ij}>R_{\text{cut}}$ 时严格为 0，也就是仅考虑局域内原子的作用。$g(\mathbf{r})$是$\delta$ 函数，与SOAP相似，将$g(\mathbf{r})$经过高斯展宽
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI0Nzg1MDk0NiwtMTcxNTcwMTY5MiwtNj
