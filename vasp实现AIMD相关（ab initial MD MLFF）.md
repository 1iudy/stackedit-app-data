...
计算分子动力学轨迹的过程中，除了直接通过DFT对原子间力进行计算，还可以通过**机器学习力场(MLFF)** 实现，通过对已计算的结构**插值**的方法进行训练，vasp使用MLFF可以进行即时训练，也可以进行

<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI3NTM5Njc4NiwtMjEyMjgwMjAyOCwtMT
E2NzM3OTU0Niw5Njc1MzA4ODEsMzIxOTc2NTkyXX0=
-->